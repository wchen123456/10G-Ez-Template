...
void drive_example() {
  ...
  // chassis.pid_drive_set(5_in, 127); //toggle
  ...
  chassis.pid_drive_set(-13_in, 127); //go to goal
  chassis.pid_wait_quick_chain();
  //score
  chassis.pid_turn_set(145_deg, 127); //turn to stack
  chassis.pid_wait_quick_chain();

  chassis.pid_drive_set(2_in, 127);
  chassis.pid_wait_quick_chain();

  chassis.pid_turn_set(-36.7_deg, 127);
  chassis.pid_wait_quick_chain();

  chassis.pid_drive_set(-6_in, 127);
  chassis.pid_wait_quick_chain();
  //grab cup
  chassis.pid_turn_set(-135_deg, 127, ccw);
  chassis.pid_wait_quick_chain();

  chassis.pid_drive_set(-23.5_in, 127); //go to goal (cntrl)
  chassis.pid_wait_quick_chain();
  //score
  chassis.pid_turn_set(-110_deg, 127, cw);
  chassis.pid_wait_quick_chain();

  chassis.pid_drive_set(15_in, 127); //go to stack
  chassis.pid_wait_quick_chain();

  chassis.pid_turn_set(52_deg, 127); //go to stack
  chassis.pid_wait_quick_chain();

  chassis.pid_drive_set(-12_in, 127); //go to stack
  chassis.pid_wait_quick_chain();
//clamp
...
///
void turn_example() {
  // Example of how to use the chain_bair to target degrees
  four_bar.set_height(12.0); // 12 inches
  four_bar.wait_until_settled();
}
